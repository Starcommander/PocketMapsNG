...
public class UnitCalculator
{
  ...
  {
    if (!Cfg.getBoolValue(NavKeyB.IsImperialUnit, false)) { return METERS_OF_KM; }
  ...
  {
    if (Cfg.getBoolValue(NavKeyB.IsImperialUnit, false)) { m = toImperalMiles(m); }
  ...
  {
    if (!Cfg.getBoolValue(NavKeyB.IsImperialUnit, false)) { return km; }
  ...
  {
    if (Cfg.getBoolValue(NavKeyB.IsImperialUnit, false)) { m = toImperalFeet(m); }
    return "" + Math.round(m);
  }
//  
//  /** Get KM or MI **/
